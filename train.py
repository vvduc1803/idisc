...
def main_worker(config, args):
    ...
    train_save_dir = os.path.join(args.base_path, config["data"]["train_data_root"])
    test_save_dir = os.path.join(args.base_path, config["data"]["test_data_root"])
    assert hasattr(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file",  default='/home/anaconda/Study/CVPR/idisc/configs/ycbv/ycbv.json', type=str, required=False)
    parser.add_argument("--master-port", type=str, required=False)
    parser.add_argument("--distributed", action="store_true")
    parser.add_argument("--base-path", default='/home/anaconda/Study/CVPR/idisc')
